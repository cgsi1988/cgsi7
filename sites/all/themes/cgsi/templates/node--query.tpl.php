  ...
  <div class="content">
    <?php print $node->body['und'][0]['value']; ?>
			...
			<p>
				...
				<?php if ($node->field_query_email['und'][0]['value']): ?>
				<a
					href="mailto:<?php print $node->field_query_email['und'][0]['safe_value']; ?>"><?php print $node->field_query_name['und'][0]['safe_value']; ?>
				</a>
				<?php else: ?>
				<?php print $node->field_query_name['und'][0]['safe_value']; ?>
				<?php endif; ?>
				<?php print $node->field_query_address['und'][0]['safe_value']; ?>
			,
				<?php print $node->field_query_city['und'][0]['safe_value']; ?>
			,
				<?php print $node->field_query_state['und'][0]['safe_value']; ?>
				<?php print $node->field_query_zip['und'][0]['safe_value']; ?>
